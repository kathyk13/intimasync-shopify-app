      ...
      >
        ...
        <IndexTable.Cell>
          <BlockStack gap="050">
            ...
            {p.ecnSku && (
              <Text as="span" variant="bodySm">ECN: {p.ecnSku}</Text>
            )}
            {!p.eldoradoSku && !p.honeysplaceSku && !p.nalpacSku && !p.ecnSku && (
