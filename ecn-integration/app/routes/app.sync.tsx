          ...
          <Card>
            <BlockStack gap="400">
              ...
              <InlineStack gap="300" wrap>
                ...
                <Button
                  loading={isBtn("sync_catalog", "ecn")}
                  onClick={() => triggerSync("sync_catalog", "ecn")}
                >
                  Sync ECN Catalog
                </Button>
              </InlineStack>
              <BlockStack gap="100">
                <Text as="p" variant="bodySm" tone="subdued">
                  Estimated sync times: Inventory 1-3 min | Honey&apos;s Place catalog 5-10 min | Nalpac catalog 15-30 min (~19K products) | Eldorado catalog 5-15 min | ECN catalog 5-15 min (differential)
                </Text>
                <Text as="p" variant="bodySm" tone="subdued">
